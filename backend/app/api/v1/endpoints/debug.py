...
def ingest_frontend_log(
    ...
    _: None = Depends(require_permission("api:/api/v1/debug/frontend-log", "create")),
) -> dict:
    push_debug_event(
        source="frontend",
        level=payload.level,
...
def get_debug_events(
    ...
    _: None = Depends(require_permission("api:/api/v1/debug/events", "view")),
...
def get_debug_summary(_: None = Depends(require_permission("api:/api/v1/debug/summary", "view"))) -> DebugSummaryResponse:
